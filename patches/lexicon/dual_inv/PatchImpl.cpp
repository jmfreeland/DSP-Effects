...
// as Dual-Chmb/Dual-Plt (see dsp/include/dsp/graphs/DualInvAlgorithm.h
// and docs/lexicon-pcm81-dual-chmb.md), with Inverse's own Duration/Low
// Slope/Mid Slope/Shape envelope controls in place of RT60 decay.
//
// Knob mapping:
...
class PatchImpl : public Patch
{
  public:
    ...
    {
        static_assert(dsp::graphs::DualInvAlgorithm::requiredWorkingBufferSize() <=
                        kWorkingBufferSize,
                      "DualInvAlgorithm needs more working buffer than the Patch provides");
        engine_.prepare(
          kSampleRate,
          std::span<float>(buffer.data(), dsp::graphs::DualInvAlgorithm::requiredWorkingBufferSize()));
    }
    ...
    void handleAction(int actionIdx) override
    {
        switch (static_cast<endless::ActionId>(actionIdx))
        {
            ...
            case endless::ActionId::kLeftFootSwitchHold:
                ...
                engine_.setRouting(seriesRouting_ ? dsp::graphs::DualInvAlgorithm::Routing::kRvbIntoFx
                                                   : dsp::graphs::DualInvAlgorithm::Routing::kParallel);
                break;
        }
    }
    ...
    void init() override
    {
        ...
        engine_.setRouting(dsp::graphs::DualInvAlgorithm::Routing::kParallel);
        ...
        engine_.setDuration(2.5f);
        engine_.setLowSlope(-0.3f);
        engine_.setMidSlope(-0.3f);
