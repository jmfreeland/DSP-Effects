...
// dsp::graphs::DenseRoomAlgorithm engine used by the Polyend Endless
// patch, so DAW testing exercises identical DSP code.
class EventideDenseRoomAudioProcessor : public juce::AudioProcessor
{
  public:
    EventideDenseRoomAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(EventideDenseRoomAudioProcessor)
};
