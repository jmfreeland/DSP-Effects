...
// JUCE VST3/Standalone wrapper around the same dsp::graphs::DualInvAlgorithm
...
class DualInvAudioProcessor : public juce::AudioProcessor
{
  public:
    DualInvAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(DualInvAudioProcessor)
};
