...
// JUCE VST3/Standalone wrapper around the same dsp::algorithms::LexiconHall
// engine used by the Polyend Endless patch, so DAW testing (Ableton,
// Bitwig, ...) exercises identical DSP code. See patches/lexicon/hall for
// the pedal-facing knob/footswitch mapping this mirrors.
