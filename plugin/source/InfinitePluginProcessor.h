...
// JUCE VST3/Standalone wrapper around the same dsp::graphs::InfiniteAlgorithm
...
class LexiconInfiniteAudioProcessor : public juce::AudioProcessor
{
  public:
    LexiconInfiniteAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(LexiconInfiniteAudioProcessor)
};
