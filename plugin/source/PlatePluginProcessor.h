...
// JUCE VST3/Standalone wrapper around the same dsp::graphs::PlateAlgorithm
...
class LexiconPlateAudioProcessor : public juce::AudioProcessor
{
  public:
    LexiconPlateAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(LexiconPlateAudioProcessor)
};
