...
// JUCE VST3/Standalone wrapper around the same dsp::graphs::ChamberAlgorithm
...
class LexiconChamberAudioProcessor : public juce::AudioProcessor
{
  public:
    LexiconChamberAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(LexiconChamberAudioProcessor)
};
