...
// JUCE VST3/Standalone wrapper around the same dsp::graphs::DualChmbAlgorithm
...
class DualChmbAudioProcessor : public juce::AudioProcessor
{
  public:
    DualChmbAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(DualChmbAudioProcessor)
};
