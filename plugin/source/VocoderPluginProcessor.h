...
// dsp::graphs::VocoderAlgorithm engine used by the Polyend Endless
// patch, so DAW testing exercises identical DSP code.
class EventideVocoderAudioProcessor : public juce::AudioProcessor
{
  public:
    EventideVocoderAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(EventideVocoderAudioProcessor)
};
