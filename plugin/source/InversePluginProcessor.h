...
// JUCE VST3/Standalone wrapper around the same dsp::graphs::InverseAlgorithm
...
class LexiconInverseAudioProcessor : public juce::AudioProcessor
{
  public:
    LexiconInverseAudioProcessor();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(LexiconInverseAudioProcessor)
};
