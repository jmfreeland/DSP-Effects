...
{
/**
 * The Lexicon PCM81 "Dual-Plt" algorithm: identical shape to Dual-Chmb
 * (see docs/lexicon-pcm81-dual-chmb.md) - a Submixer routing a "Dual
 * Shifter" FX block (two independent PitchShiftVoice-based voices with
 * Fbk/X-Fbk between them) against a reverb block - with Plate in place
 * of Chamber. See dsp/Submixer.h and docs/lexicon-pcm81-reference.md's
 * "The Pitch algorithms" section.
 */
class DualPltAlgorithm
{
  public:
    ...
    // -- Reverb Block pass-throughs (Plate) --
