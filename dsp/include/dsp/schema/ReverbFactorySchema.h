...
inline const AlgorithmSchema& reverbFactorySchema()
{
    static const Stage stages[] = {
        ...
        { "predelay", "Predelay", StageKind::kProcessing, "0-500ms ahead of the network" },
        { "gate", "Gate", StageKind::kProcessing,
          "Envelope follower + Threshold/Speed/Time - crossfades On/Off Decay+EQ" },
        { "lines", "Delay 1-6", StageKind::kFeedback, "Fixed per-line delays, own EQ crossover" },
